...
namespace QuanLyCongViec
{
    internal class XuLiDuLieu
    {
        ...
        // Sửa công việc:
        public void sua(int ID_CongViec, string TenCongViec, string NhomCongViec, DateTime NgayBatDau, DateTime NgayKetThuc, string TrangThai, string NhanVien_ID)
        {
            ...
            string updateQuery = "UPDATE CongViec SET ID_CongViec=@ID_CongViec, TenCongViec = @TenCongViec, NhomCongViec = @NhomCongViec, NgayBatDau = @NgayBatDau, NgayKetThuc = @NgayKetThuc, " +
                                 "TrangThai = @TrangThai, NhanVien_ID=@NhanVien_ID WHERE ID_CongViec = @ID_CongViec";
