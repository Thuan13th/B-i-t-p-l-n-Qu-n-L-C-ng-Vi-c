...
namespace QuanLyCongViec
{
    public partial class Form_btnQuanLyCongViec : Form
    {
        ...
        {
            string sql = "select ID_NhanVien, TenNhanVien, ID_CongViec,TenCongViec,NhomCongViec,NgayBatDau,NgayKetThuc,TrangThai from CongViec inner join NhanVien on ID_NhanVien = NhanVien_ID";
        ...
        private void btnSua_Click(object sender, EventArgs e)
        {
            ...
            dt = kn.taoBang(s);
            kn.sua(int.Parse(txtID_CongViec.Text), txtTenCongViec.Text, txtNhomCongViec.Text, dtpNgayBatDau.Value, dtpNgayKetThuc.Value, cmbTrangThai.Text, ID_NhanVien.Text);
            LoadDuLieu();
        }
