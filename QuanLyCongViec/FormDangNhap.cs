...
namespace QuanLyCongViec
{
    public partial class FormDangNhap : Form
    {
        ...
        {
            string queryDangNhap = "SELECT *  FROM TaiKhoan Where TenDangNhap = N'" + txtTaiKhoan.Text + "' and MatKhau = '" + txtMatKhau.Text + "'";
            SqlConnection conn = new SqlConnection(@"Data Source=THUAN\SQLEXPRESS;Initial Catalog=QuanLyCongViec_Short1;Integrated Security=True");
